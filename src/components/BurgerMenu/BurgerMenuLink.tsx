...
const BurgerMenuLink: FC<LindData> = ({ title, to }) => {
  ...
  return (
    <Link
      ...
      className="cursor-pointer text-center text-[22px] duration-500 text-[#151419] font-light py-[6px] z-[900] border px-10 bg-[size:300%] bg-[#fbfbfb] bg-[linear-gradient(135deg,transparent_0%,transparent_50%,#151419_50%)] hover:bg-[position:99%] hover:text-[#fbfbfb]"
