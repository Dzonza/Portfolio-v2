...
const Project: FC<ProjectData> = ({ title, images, logo, languages }) => {
  ...
  return (
    <div className="relative w-full">
      <motion.div
        ...
        className="p-3 absolute w-[350px] h-[250px] shadow-[0_15px_45px_rgba(0,0,0,0.25)] bg-[#fbfbfb] z-20 pointer-events-none rounded-[5px] "
        style={{
          x: smoothX,
          y: smoothY,
          translateX: '-40%',
      ...
      >
        {isHovered && (
          <>
            ...
            <div className="flex justify-center gap-3 absolute top-0 -translate-y-full left-1/2 -translate-x-1/2">
