  ...
  return (
    ...
    >
      ...
      <LanguageBox
        ...
        setIsHoveredIcon={setIsHoveredIcon}
      />
      <p className="text-[#fbfbfb] text-[12px] xs:text-[14px] s:text-[16px] w-[300px] xs:w-[350px] s:w-[420px] text-right font-extralight absolute top-[25%] right-10 pr-5 border-r">
        Creative Frontend Developer skilled in turning ideas into engaging
        digital experiences.
      </p>
      <div className="absolute  bottom-[20%] text-[12px] xs:text-[14px] s:text-[16px] w-[280px] xs:w-[320px] s:w-[380px] h-[55px] xs:h-[65px] s:h-[75px] right-[10%] s:right-[20%] ">
        <p
